...
* The mean total steps per day is: `r mean_total_steps`.
* The median total steps per day is: `r median_total_steps`.
...
The time when the maximum occurs is `r timeMax`. 
...
* The mean total steps per day is: `r rev_mean_total_steps`.
* The median total steps per day is: `r rev_median_total_steps`.
