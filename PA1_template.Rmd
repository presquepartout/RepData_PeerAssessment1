...
medianNA <- format(as.character(median_total_steps), scientific = FALSE)
meanRev <- format(as.character(rev_mean_total_steps), scientific = FALSE)
medianRev <- format(as.character(rev_median_total_steps), scientific = FALSE)
deltaMean <- rev_mean_total_steps - mean_total_steps
deltaMed <- rev_median_total_steps - median_total_steps
```
